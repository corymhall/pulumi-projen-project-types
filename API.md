...
| <code><a href="#@hallcor/pulumi-projen-project-types.PythonComponentOptions.property.release">release</a></code> | <code>boolean</code> | Add release management to this project. |
...
##### `release`<sup>Optional</sup> <a name="release" id="@hallcor/pulumi-projen-project-types.PythonComponentOptions.property.release"></a>
...
| <code><a href="#@hallcor/pulumi-projen-project-types.TagReleaseOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="@hallcor/pulumi-projen-project-types.TagReleaseOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="@hallcor/pulumi-projen-project-types.TagReleaseOptions.property.releaseWorkflowEnv"></a>
...
| <code><a href="#@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.npmDistTag">npmDistTag</a></code> | <code>string</code> | The npmDistTag to use when publishing from the default branch. |
...
| <code><a href="#@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.releaseBranches">releaseBranches</a></code> | <code>{[ key: string ]: projen.release.BranchOptions}</code> | Defines additional release branches. |
| <code><a href="#@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.releaseToNpm">releaseToNpm</a></code> | <code>boolean</code> | Automatically release to npm when new versions are introduced. |
...
| <code><a href="#@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
##### `npmDistTag`<sup>Optional</sup> <a name="npmDistTag" id="@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.npmDistTag"></a>
...
##### `package`<sup>Optional</sup> <a name="package" id="@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.package"></a>
...
##### `release`<sup>Optional</sup> <a name="release" id="@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.release"></a>
...
##### `releaseBranches`<sup>Optional</sup> <a name="releaseBranches" id="@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.releaseBranches"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.releaseEnvironment"></a>
...
##### `releaseToNpm`<sup>Optional</sup> <a name="releaseToNpm" id="@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.releaseToNpm"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="@hallcor/pulumi-projen-project-types.TypeScriptComponentOptions.property.releaseWorkflowEnv"></a>
...
| <code><a href="#@hallcor/pulumi-projen-project-types.TypeScriptProjectProps.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#@hallcor/pulumi-projen-project-types.TypeScriptProjectProps.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="@hallcor/pulumi-projen-project-types.TypeScriptProjectProps.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="@hallcor/pulumi-projen-project-types.TypeScriptProjectProps.property.releaseWorkflowEnv"></a>
