...
import type { EslintOptions, GithubCredentials, PrettierOptions, PulumiTypeScriptOptions } from '../../';

/**
 * TypeScriptComponentOptions
 */
export interface TypeScriptComponentOptions {
  /**
...
`NpmAccess.PUBLIC`.
  ...
  readonly pulumiOptions?: PulumiTypeScriptOptions;
  /**
