...
import type { github, GitOptions, IgnoreFileOptions, javascript, LoggerOptions, Project, ProjenrcJsonOptions, python, release, RenovatebotOptions, SampleReadmeProps, typescript } from 'projen';
