...
import type { build, github, GitOptions, IgnoreFileOptions, javascript, LoggerOptions, Project, ProjenrcJsonOptions, python, release, RenovatebotOptions, SampleReadmeProps, typescript } from 'projen';
import type { GithubCredentials, PulumiPythonOptions } from '../../';

/**
 * PythonComponentOptions
 */
export interface PythonComponentOptions {
  /**
   ...
   */
  readonly buildWorkflowOptions?: build.BuildWorkflowCommonOptions;
  /**
